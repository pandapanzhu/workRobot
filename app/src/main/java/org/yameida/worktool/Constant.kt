...
object Constant {
    ...
    private const val DEFAULT_HOST = "wss://worktool.zeita.com.cn/workrobot"
    ...
    fun getCheckUpdateUrl() = "${getBaseUrl()}/robot/checkUpdate"

    fun getMasterCheckUpdateUrl() = "https://worktool.zeita.com.cn/workrobot/robot/checkUpdate"
